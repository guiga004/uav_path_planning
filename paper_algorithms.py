...
def partitioning(a1, a2, x, y):
    ...
    :return: P, list containing bounds for sub partitions
    """
...
def get_vehicle_velocity(is_uav, is_flying, is_moving, uA_max, uG_max, v, vnext):
    """
...
arXiv preprint arXiv:1908.05727,2019.
'''
def partition_feasibility_check(n, m, e, u_max, B_min, x_bar, y_bar):
